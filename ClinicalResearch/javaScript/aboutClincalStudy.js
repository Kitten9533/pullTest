	...
	var clinicalStudy = {
		...
		goNext: function(){
			...
			$('#list').on("click","li",function(){
				...
				window.location.href = '../pages/textDetail.html?v=1.0.0&resourceId=' + resourceId + '&title=' + txtTitle + '&tabId=' + _this.tabId + 'wechatId=' + MedtapCore.getRequest('wechatId');
				//MedtapCore.pushNewWindow("textDetail.html?v=0807&resourceId="+ resourceId +"&title="+ txtTitle +"&tabId="+ _this.tabId);
			});
		}
